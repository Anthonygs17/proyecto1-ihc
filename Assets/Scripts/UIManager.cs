...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject typesMenuCanvas;
    ...
    void Start()
    {
        ...
        GameManager.instance.OnTypesMenu += ActivateTypesMenu;
    ...
    private void ActivateMainMenu()
    {
        ...
        typesMenuCanvas.transform.GetChild(0).transform.DOScale(new Vector3(0, 0, 0), 0.5f);
        typesMenuCanvas.transform.GetChild(1).transform.DOScale(new Vector3(0, 0, 0), 0.3f);
        typesMenuCanvas.transform.GetChild(1).transform.DOMoveY(210, 0.3f);
        ...
        itemsMenuCanvas.transform.GetChild(1).transform.DOMoveY(210, 0.3f);
    ...
    private void ActivateTypesMenu()
    {
        ...
        typesMenuCanvas.transform.GetChild(0).transform.DOScale(new Vector3(1, 1, 1), 0.5f);
        typesMenuCanvas.transform.GetChild(1).transform.DOScale(new Vector3(1, 1, 1), 0.3f);
        typesMenuCanvas.transform.GetChild(1).transform.DOMoveY(300, 0.3f);
